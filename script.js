...
// counter
var date= new Date('oct 30 2021 00:00:00');
function counts(){
    var now = new Date();
    gap=date-now;
    ...
    var minuts=Math.floor(gap / 1000 / 60) % 60;
    var seconds=Math.floor(gap / 1000) % 60;

    document.getElementById('d').innerText= days;
    document.getElementById('h').innerText= hours;
    document.getElementById('m').innerText= minuts;
...
// 
$(document).ready(function(){
    $('.faq_pluse1').click(function(event){
        $('.modal-1').toggleClass('active');
        $('body').toggleClass('lock');
    })
    $('.faq_pluse2').click(function(event){
        $('.modal-2').toggleClass('active');
        $('body').toggleClass('lock');
    })
    $('.faq_pluse3').click(function(event){
        $('.modal-3').toggleClass('active');
        $('body').toggleClass('lock');
    })
    $('.faq_pluse4').click(function(event){
        $('.modal-4').toggleClass('active');
        $('body').toggleClass('lock');
    })
    $('.faq_pluse5').click(function(event){
        $('.modal-5').toggleClass('active');
        $('body').toggleClass('lock');
    })
    $('.faq_pluse6').click(function(event){
        $('.modal-6').toggleClass('active');
        $('body').toggleClass('lock');
    })
});
// активное меню
...
pluseCard.onclick = function (){
if (counter == 1){
    document.getElementById("ImgGallery").src = "img/our-card1.png";
    counter++;
}
else if (counter == 2){
    document.getElementById("ImgGallery").src = "img/our-card1-2.png";
    counter++;
}
else if (counter == 3){
    document.getElementById("ImgGallery").src = "img/our-card1-3.png";
    counter++;
}
else if (counter == 4){
    document.getElementById("ImgGallery").src = "img/our-card1-4.png";
    counter++;
}
};
var counter2=2;
pluseCard2.onclick = function (){
if (counter2 == 1){
    document.getElementById("ImgGallery2").src = "img/our-card2.png";
    counter2++;
}
else if (counter2 == 2){
    document.getElementById("ImgGallery2").src = "img/our-card2-2.png";
    counter2++;
}
else if (counter2 == 3){
    document.getElementById("ImgGallery2").src = "img/our-card2-3.png";
    counter2++;
}
else if (counter2 == 4){
    document.getElementById("ImgGallery2").src = "img/our-card2-4.png";
    counter2++;
}
};
var counter3=2;
pluseCard3.onclick = function (){
if (counter3 == 1){
    document.getElementById("ImgGallery3").src = "img/our-card3.png";
    counter3++;
}
else if (counter3 == 2){
    document.getElementById("ImgGallery3").src = "img/our-card3-2.png";
    counter3++;
}
else if (counter3 == 3){
    document.getElementById("ImgGallery3").src = "img/our-card3-3.png";
    counter3++;
}
else if (counter3 == 4){
    document.getElementById("ImgGallery3").src = "img/our-card3-4.png";
    counter3++;
}
};
var counter4=2;
pluseCard4.onclick = function (){
if (counter4 == 1){
    document.getElementById("ImgGallery4").src = "img/our-card4.png";
    counter4++;
}
else if (counter4 == 2){
    document.getElementById("ImgGallery4").src = "img/our-card4-2.png";
    counter4++;
}
else if (counter4 == 3){
    document.getElementById("ImgGallery4").src = "img/our-card4-3.png";
    counter4++;
}
else if (counter4 == 4){
    document.getElementById("ImgGallery4").src = "img/our-card4-4.png";
    counter4++;
}
};
var counter5=2;
pluseCard5.onclick = function (){
if (counter5 == 1){
    document.getElementById("ImgGallery5").src = "img/our-card5.png";
    counter5++;
}
else if (counter5 == 2){
    document.getElementById("ImgGallery5").src = "img/our-card5-2.png";
    counter5++;
}
};
var counter6=2;
pluseCard6.onclick = function (){
if (counter6 == 1){
    document.getElementById("ImgGallery6").src = "img/our-card6.png";
    counter6++;
}
else if (counter6 == 2){
    document.getElementById("ImgGallery6").src = "img/our-card6-2.png";
    counter6++;
}
else if (counter6 == 3){
    document.getElementById("ImgGallery6").src = "img/our-card6-3.png";
    counter6++;
}
else if (counter6 == 4){
    document.getElementById("ImgGallery6").src = "img/our-card6-4.png";
    counter6++;
}
};
var counter7=2;
pluseCard7.onclick = function (){
if (counter7 == 1){
    document.getElementById("ImgGallery7").src = "img/our-card7.png";
    counter7++;
}
else if (counter7 == 2){
    document.getElementById("ImgGallery7").src = "img/our-card7-2.png";
    counter7++;
}
else if (counter7 == 3){
    document.getElementById("ImgGallery7").src = "img/our-card7-3.png";
    counter7++;
}
else if (counter7 == 4){
    document.getElementById("ImgGallery7").src = "img/our-card7-4.png";
    counter7++;
}
else if (counter7 == 5){
    document.getElementById("ImgGallery7").src = "img/our-card7-5.png";
    counter7++;
}
else if (counter7 == 6){
    document.getElementById("ImgGallery7").src = "img/our-card7-6.png";
    counter7++;
}
};